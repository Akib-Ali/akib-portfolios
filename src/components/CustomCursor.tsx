...
//       // Agar target ek link, button ya image hai toh variant change karo
...
//       height: 60,
//       width: 60,
//       backgroundColor: "rgba(45, 78, 157, 0.1)", // Light Blue Tint
//       border: "1px solid #8CC63F",
//       mixBlendMode: "normal", // Professional Look
//     },
//     text: {
//       height: 80,
//       width: 80,
//       backgroundColor: "#2D4E9D",
//       mixBlendMode: "difference", // Text ke upar color invert ho jayega
//       border: "none",
//     }
//   };
...
//       {/* Small Core Dot - Exact Precision */}
//       <motion.div
...
export default function CustomCursor() {
  ...
  useEffect(() => {
    // FIX: Added MouseEvent type here
    const moveMouse = (e: MouseEvent) => {
      mouseX.set(e.clientX);
      mouseY.set(e.clientY);

      const target = e.target as HTMLElement; // Added HTMLElement type casting
  ...
  // Types for Variants to satisfy TS
  const variants: any = {
    default: {
      height: 32,
      width: 32,
